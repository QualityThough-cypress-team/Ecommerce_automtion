...
context('Actions', () => {
  ...
  it('.type() - type into a DOM element', () => {
    ...
    cy.get('#email1').click();
    cy.get('#email1').should('be.enabled');
    //it is avaialble to perfrom some action 
    cy.get('#email1').should('not.be.checked');
    // this is not checked means  =>  not selected 
    cy.get('#email').should('be.visible') //positie test
    cy.get('#email').should('not.be.visible')//negaitve assertion 
