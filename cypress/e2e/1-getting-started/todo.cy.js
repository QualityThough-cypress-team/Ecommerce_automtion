...
describe('example to-do app', () => {
  ...
  it('displays two todo items by default', () => {
    ...
    cy.get('[data-id="1745981915894"] > .view > label')
    ...
    cy.get('[data-id="1745981915895"] > .view > label').should('be.visible');
    cy.get('[data-id="1745981915895"] > .view > label').should('have.text', 'Walk the dog');
    /* ==== End Cypress Studio ==== */
  })
